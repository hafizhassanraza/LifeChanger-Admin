...
public class Adapter_tInvestment extends RecyclerView.Adapter<Adapter_tInvestment.ViewHolder> {
    private List<Model_Investment> model_tInvestment;
    ...
    public Adapter_tInvestment(Context context, List<Model_Investment> model_tInvestment) {
        this.context = context;

        this.model_tInvestment = model_tInvestment;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final Model_Investment current_tInvestment = model_tInvestment.get(position);



        holder.txt_date.setText(model_tInvestment.get(position).getDate());
        holder.txt_amount.setText(model_tInvestment.get(position).getAmount()+" Rs");
        holder.txt_AcDeposit.setText(model_tInvestment.get(position).getAc_deposit());
                ...
                MaterialDialog mDialog = new MaterialDialog.Builder((Activity) v.getContext())
                        ...
                        .setPositiveButton("Delete", R.drawable.ic_baseline_delete_24, new MaterialDialog.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                ...
                                DeleteReq(model_tInvestment.get(position).getUserID(),
                                        model_tInvestment.get(position).getId());
                            }
                        })
        ...
        holder.btn_iProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("id",model_tInvestment.get(position).getId());
                intent.putExtra("userId", model_tInvestment.get(position).getUserID());
